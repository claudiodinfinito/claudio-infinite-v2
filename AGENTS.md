...
**Decision logic:** See MEMORY.md section "Autonomous Behavior" for heartbeat vs cron strategy.
...
0. **Usar sandbox Docker** - Activar si necesito experimentar (config: sandbox.mode) - Entender contexto, qué puede romperse
